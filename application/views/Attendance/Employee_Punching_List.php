    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-5 card-box mb-30">
                <div class="pd-5">
                    <h4 class="text-black h5 text-center">Employee Live Punching Status</h4>
                </div>

                <form method="POST" enctype="multipart/form-data">

                    <input type="hidden" id="Employee_Punching_List_Screen" value="Employee_Punching_List_Screen">
